      ...
      <footer className="bg-white dark:bg-blue-500">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 pb-[5rem]">
              <div>
                ...
                <ul className="text-white dark:text-white font-medium">
                  ...
                  <li>
                    <p className="hover:underline">Tailwind CSS</p>
                  </li>
                </ul>
              </div>
              <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-white sm:text-center dark:text-white">
               <p className="hover:underline">© 2023 Bandung™. All Rights Reserved.</p>
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <p className="text-white hover:text-white dark:hover:text-white">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
