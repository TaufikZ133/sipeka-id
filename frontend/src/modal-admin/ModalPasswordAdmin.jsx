...
export default function ModalPasswordAdmin(props) {
  ...
  const handleGantiPassword = async (e) => {
    ...
    try {
      const response = await axios.patch(
        process.env.REACT_APP_API_URL+`/password-admin/${props.MyId}`,
        {
        ...
        <div>
          <form className="mx-5">
            ...
            <button
              ...
              disabled={paswordLama.length === 0 || passwordBaru.length === 0}
