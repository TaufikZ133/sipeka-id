...
export default function AdminDashboard() {
  ...
  const [jumlahGaji, setJumlahGaji] = useState("0");
  ...
  const getKaryawan = async () => {
    try {
      const response = await axios.get(process.env.REACT_APP_API_URL+"/karyawan");
      setJumlahkaryawan(response.data.count);
    } catch (error) {
      console.log(error)
    }
  }
  ...
  const getGaji = async () => {
    try {
      const response = await axios.get(process.env.REACT_APP_API_URL+"/gaji");
      setJumlahGaji(response.data.count);
    } catch (error) {
      console.log(error)
    }
  }
      ...
      >
        ...
        <div>
          <ul className="m-auto">
            ...
            <li
              onClick={() => navigate(`/data-admin/${adminId}`)}
            ...
            <li className="cursor-pointer flex items-center gap-x-4 p-4 hover:opacity-50 rounded-md mt-2 mx-3">
              ...
              <h5
                onClick={() => navigate(`/kelola-gaji/${adminId}`)}
                className={`text-base text-white mr-4 font-montserrat font-semibold flex-1 text-[13px] leading-[20px] ${
                  !open && "hidden"
                }`}
              >
            ...
            <li className="cursor-pointer flex items-center gap-x-4 p-4 hover:opacity-50 rounded-md mt-2 mx-3">
              ...
              <h5
                onClick={() => navigate(`/kelola-dokumen/${adminId}`)}
                className={`text-base text-white mr-4 font-montserrat font-semibold flex-1 text-[13px] leading-[20px] ${
                  !open && "hidden"
                }`}
              >
            ...
            <li className="cursor-pointer flex items-center gap-x-4 p-4 hover:opacity-50 rounded-md mt-2 mx-3">
              ...
              <h5
                onClick={() => navigate(`/chat-admin/${adminId}`)}
                className={`text-base text-white mr-4 font-montserrat font-semibold flex-1 text-[13px] leading-[20px] ${
                  !open && "hidden"
                }`}
              >
            ...
            <div className="bg-white text-center p-2 font-bold rounded-[12px] mx-[1rem] mt-[2rem] shadow-2xl">
              ...
              <div className=" bg-white p-3 mb-4 font-medium">
                ...
                <p className="text-[16px] font-normal text-gray-500  w-1/2 m-auto mb-2">
                  Silahkan Melakukan Kelola Data Karyawan Anda
                </p>
                <div className="flex pb-5">
                  <div className="calendar w-1/6 shadow-2xl mt-5 m-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-[1.050] duration-300">
                  ...
                  <div className="kehadiran w-1/6 shadow-2xl mt-5 m-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-[1.050] duration-300">
                    <div className="block rounded-t overflow-hidden text-center">
                      ...
                      <div className="border-l border-r border-b rounded-b-lg text-center border-white bg-white -pt-2 -mb-1">
                        <span className="text-sm">Jumlah Karyawan</span>
                      </div>
                      <div className="pb-2 border-l border-r border-b rounded-b-lg text-center border-white bg-white">
                        <span className="text-xs leading-normal">{time}</span>
                      </div>
                  ...
                  <div className="slip gaji w-1/6 shadow-2xl mt-5 m-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-[1.050] duration-300">
                    <div className="block rounded-t overflow-hidden text-center">
                      ...
                      <div className="border-l border-r border-b rounded-b-lg text-center border-white bg-white -pt-2 -mb-1">
                        <span className="text-sm">Jumlah Slip Gaji</span>
                      </div>
                      <div className="pb-2 border-l border-r border-b rounded-b-lg text-center border-white bg-white">
                        <span className="text-xs leading-normal">{time}</span>
                      </div>
